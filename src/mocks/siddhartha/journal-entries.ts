...
export const journalEntry9_TheFerryman: MockedJournalEntry = {
  ...
  sections: [
    {
      text: "Today, I have found a new chapter in my journey by the river, guided by a humble ferryman named Vasudeva. After the profound realization I experienced at the riverbank, I sought refuge and guidance. It is here, with Vasudeva, that I have discovered a way of life that feels both peaceful and profound.",
      highlight: {
