...
export type BreadcrumbHighlightQueryQueryVariables = Exact<{
  highlightId: Scalars['ID'];
}>;


export type BreadcrumbHighlightQueryQuery = { __typename?: 'Query', highlight?: { __typename?: 'Highlight', id: string, excerpt: string } | null };
