...
export type BreadcrumbHighlightQueryVariables = Exact<{
  highlightId: Scalars['ID'];
}>;


export type BreadcrumbHighlightQuery = { __typename?: 'Query', highlight?: { __typename?: 'Highlight', id: string, entry: { __typename?: 'Entry', entryKey: string, date: string } } | null };
