...
describe("day", () => {
  test("should convert from IpsumDateTime", () => {
  ...
  describe("add", () => {
    test("adding one month to last day of month", () => {
  ...
  describe("isBetween", () => {
    test("last day of month should be between first and last", () => {
      const day = IpsumDay.fromString("1/31/2021");
