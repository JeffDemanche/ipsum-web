...
describe("comment-html", () => {
  describe("replaceCommentDiv", () => {
    test("correct when there's one a comment div", () => {
      expect(
        replaceCommentDiv(
    ...
    test("correct when there's a comment div in the middle", () => {
      expect(
        replaceCommentDiv(
    ...
    test("if there are two non-consecutive comment divs, it should replace the first one and delete the second", () => {
      expect(
        replaceCommentDiv(
